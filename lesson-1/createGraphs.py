...
###BIPARTITE GRAPHS### a graph whose nodes can be split into two sets L and R and every edge connects a node in L with a node in R
...
def create_projection(B):
    B.add_edges_from([('D',1),('H',1),('B',2),('C',2),('D',2),('E',2),('G',2),('E',3),('F',3),('H',3),('J',3),('E',4),('I',4),('J',4)])
